...
if __name__ == "__main__":
    ...
    # print(dataset["train"].shape, len(dataset['train']))
    # print(dataset['train'])
    # print(dataset['train'][0])
    for split in dataset:
        print(f"{split}: {len(dataset[split]['text'][0])} characters\n")
    # print(len(dataset['train']['text'][0]))
    # print(len(dataset['validation']['text'][0]))
    # print(len(dataset['test']['text'][0]))

    # print(dir(datasets.dataset_dict.DatasetDict))
